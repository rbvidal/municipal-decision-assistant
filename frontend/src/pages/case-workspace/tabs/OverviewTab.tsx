      ...
      <Panel>
        <PropertyGrid
          items={[
            ...
            { label: 'Priorität', value: caseData.priority === 'high' ? 'Hoch' : caseData.priority === 'medium' ? 'Mittel' : 'Niedrig' },
            { label: 'Risiko', value: caseData.risk === 'gering' ? 'Gering' : caseData.risk === 'mittel' ? 'Mittel' : 'Hoch' },
