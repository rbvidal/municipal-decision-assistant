...
export const mockSuggestions: MockSuggestion[] = [
  {
    ...
    description: 'Das Vorhaben fällt unter die Verfahrensfreiheit nach § 65 BauO NRW. Prüfen Sie die Anwendung dieser Vorschrift.',
  ...
  },
  {
    ...
    description: 'Für die Sondernutzung des Marktplatzes fehlen noch der Lageplan und die Zustimmung des Ordnungsamtes.',
  ...
  },
  {
    ...
    description: 'Die Polizei hat keine Einwände gegen die temporäre Sperrung der Schulstraße am 15. November 2026.',
  },
];
...
export const WORKBENCH_GREETINGS = [
  'Guten Morgen',
  'Guten Tag',
  'Guten Abend',
] as const;
