...
export const initialDocuments: KnowledgeDocument[] = [
  ...
  },
  {
    ...
    relatedProcedures: [],
    downloads: [
      { id: 'dl-4', filename: 'VV_BauO_NRW_65.pdf', filetype: 'pdf', size: '1.8 MB' },
    ],
  ...
  },
  {
    ...
    snippet: 'Diese Richtlinie beschreibt das Verfahren zur Prüfung von Lärmschutzanforderungen im Rahmen der Baugenehmigung und verweist auf die TA-Lärm.',
    fullText: 'Verfahrensrichtlinie für Lärmschutz im Bauaufsichtsverfahren\n\nBei Bauvorhaben mit zu erwartenden Lärmimmissionen ist eine schalltechnische Untersuchung nach TA-Lärm durchzuführen. Die Ergebnisse sind dem Bauantrag beizufügen.',
    toc: [
  ...
  },
  {
    ...
    snippet: 'Mustervorlage für eine kommunale Stellplatzsatzung nach § 48 BauO NRW. Enthält Richtwerte für notwendige Stellplätze nach Nutzungsart.',
    fullText: 'Muster-Stellplatzsatzung für Kommunen\n\nDiese Mustersatzung dient als Vorlage für Kommunen zur Regelung der Stellplatzpflicht nach § 48 BauO NRW.',
    toc: [
