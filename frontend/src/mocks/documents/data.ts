...
export type DocumentType = 'Antrag' | 'Lageplan' | 'Nachweis' | 'Beilage' | 'Vorlage' | 'Formular' | 'Sonstiges';
...
export const DOCUMENT_STATUS_COLORS: Record<DocumentStatus, 'success' | 'warning' | 'error' | 'neutral'> = {
  'Aktiv': 'success',
  'In Prüfung': 'warning',
  'Fehlend': 'error',
  'Archiviert': 'neutral',
...
export const mockDocuments: DocumentItem[] = [
  {
    ...
    history: [
      { id: 'h1', title: 'Dokument hochgeladen', timestamp: '15.05.2024, 10:34', author: 'Sabine Müller', status: 'completed' },
      { id: 'h2', title: 'OCR-Texterkennung abgeschlossen', timestamp: '15.05.2024, 10:35', author: 'System', status: 'completed' },
      { id: 'h3', title: 'Vektordatenbank-Indizierung', timestamp: '15.05.2024, 10:36', author: 'System', status: 'completed' },
    ],
    ocrStatus: 'COMPLETED',
  ...
  },
  {
    ...
    versions: [
      { version: 'v1.0', date: '12.05.2024', author: 'Thomas Müller', isCurrent: true },
    ],
    references: [
      { id: 'r3', title: '§ 2 BauVorlV — Bauvorlagenverordnung', type: 'article' },
    ],
    history: [
      { id: 'h4', title: 'Dokument hochgeladen', timestamp: '12.05.2024, 09:15', author: 'Thomas Müller', status: 'completed' },
    ],
    ocrStatus: 'COMPLETED',
    vektorisierung: 'SUCCESS',
    chunkCount: 12,
  ...
  },
  {
    ...
    history: [
      { id: 'h5', title: 'Dokument zur Prüfung eingereicht', timestamp: '18.05.2024, 14:22', author: 'Sabine Müller', status: 'completed' },
      { id: 'h6', title: 'Fachliche Prüfung läuft', timestamp: '19.05.2024, 08:15', author: 'System', status: 'info' },
    ],
    ocrStatus: 'COMPLETED',
  ...
  },
  {
    ...
    versions: [
      { version: 'v1.0', date: '08.05.2024', author: 'Thomas Müller', isCurrent: true },
    ],
    references: [],
    history: [
      { id: 'h7', title: 'Dokument hochgeladen', timestamp: '08.05.2024, 11:00', author: 'Thomas Müller', status: 'completed' },
    ],
    ocrStatus: 'COMPLETED',
    vektorisierung: 'SUCCESS',
    chunkCount: 4,
  ...
  },
  {
    ...
    versions: [],
    references: [
      { id: 'r6', title: '§ 48 BauO NRW — Stellplatzpflicht', type: 'gavel' },
    ],
    history: [
      { id: 'h8', title: 'Dokument als fehlend markiert', timestamp: '01.05.2024, 08:00', author: 'System', status: 'system' },
    ],
    ocrStatus: '—',
    vektorisierung: '—',
    chunkCount: 0,
  ...
  },
  {
    ...
    references: [
      { id: 'r7', title: '§ 65 BauO NRW', type: 'gavel' },
    ],
    history: [
      { id: 'h9', title: 'Dokument archiviert', timestamp: '12.03.2023, 16:45', author: 'Sabine Müller', status: 'completed' },
    ],
    ocrStatus: 'COMPLETED',
    vektorisierung: 'SUCCESS',
    chunkCount: 18,
