...
export const knowledgeService: KnowledgeService = useMock ? mockKnowledgeService : restKnowledgeService;
...
export const supervisorService: SupervisorService = useMock ? mockSupervisorService : restSupervisorService;
