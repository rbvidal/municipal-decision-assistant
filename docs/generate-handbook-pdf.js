...
(async () => {
  ...
  const mdPath = path.join(docsDir, 'Architecture-Handbook.md');
  const pdfPath = path.join(docsDir, 'Enterprise-AI-Platform-Architecture-Handbook.pdf');

  console.log('Reading Architecture-Handbook.md...');
...
<head>
<meta charset="utf-8">
<title>Enterprise AI Platform — Architecture & Engineering Handbook</title>
<style>
...
${body}
  ...
  const htmlPath = path.join(docsDir, 'Architecture-Handbook.html');
  ...
  await page.pdf({
    ...
    headerTemplate: '<div style="font-size:8pt;color:#666;text-align:center;width:100%;">Enterprise AI Platform — Architecture &amp; Engineering Handbook</div>',
